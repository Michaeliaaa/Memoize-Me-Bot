...
def help(update, context):
    ...
    helpMessage += "/reminder - set a reminder for yourself every 24 hours from the time this command is used\n"
    helpMessage += "/stopreminder - set a reminder for yourself every 24 hours from the time this command is used\n"
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            ADD_QNS: [MessageHandler(Filters.text | Filters.photo, add_qns)
            ],
