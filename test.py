...
TOKEN = "1294504733:AAEa5dV5h8FfXrUTzca_MCZrQAjuNNl2xbg"
...
def view_deck(update, context):
    ...
    try:
        ...
        if(connection):
            ...
            connection.close()
            # print("PostgreSQL connection is closed")
            update.message.reply_text('Which deck would you want to look into?')
        return VIEW_QNA
    ...
    if (getText(update) == "/cancel"):
        ...
        try:
            ...
            if list(remaining).pop(0) == 0:
                update.message.reply_text("You had finished the test.")
